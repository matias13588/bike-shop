...
RENT_MENU() {
    # get available bikes
    AVAILABLE_BIKES=$($PSQL "
        SELECT bike_id, type, size FROM bikes 
    ...
    then
        ...
        then
            ...
            BIKE_AVAILABILITY=$($PSQL "
                SELECT available FROM bikes 
